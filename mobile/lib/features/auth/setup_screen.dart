...
/// First-run admin account creation (mirrors web /setup).
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref
          ...
          .setup(_email.text.trim(), _name.text.trim(), _password.text);
    } catch (e) {
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'This Nurby server has no users yet. Create the first admin.',
                    textAlign: TextAlign.center,
