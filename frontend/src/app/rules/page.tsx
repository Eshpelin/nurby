...
interface TelegramChannelOption {
  ...
  // Phase 4. Household sharing fields. owned_by_me lets the rule
  // builder annotate non-owned channels with "(shared by <name>)".
...
// Lets the household leave free-text annotations (false alarm, this
// was Dad arriving home, etc.). Telegram-sourced notes show a small
// pill so the operator can correlate.
interface EventNote {
  id: string;
  event_id: string;
