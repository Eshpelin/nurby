...
from services.api.routes import admin_stats, audio, auth, cameras, detection_models, digests, events, invites, notifications, observations, ollama_deploy, persons, providers, recordings, rules, search, summaries, system, timeline, transcripts, users
